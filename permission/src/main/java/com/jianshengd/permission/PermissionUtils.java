...
import com.jianshengd.permission.menu.Default;
import com.jianshengd.permission.menu.OPPO;
import com.jianshengd.permission.menu.VIVO;
import com.jianshengd.permission.menu.base.IMenu;
...
public class PermissionUtils {
     ...
     * 权限是否返回成功
     * @param context 上下文
     * @param gantedResults 授予结果
     * @return true 权限授予，false 权限被拒绝
     */
     ...
     * @param permissions 权限
     * @return true 过去拒绝过但并未点击不再提示，false 过去拒绝并点击不再提示
     */
